...
const languageOptions = {
  en: {
    icon: 'https://static.easify.xyz/lp/assets/flags/flag-uk.svg',
    label: 'English'
  },
  de: {
    icon: 'https://static.easify.xyz/lp/assets/flags/flag-de.svg',
    label: 'German'
  },
  es: {
    icon: 'https://static.easify.xyz/lp/assets/flags/flag-es.svg',
    label: 'Spanish'
  }
};
