...
const logoMap = {
  BTC: 'https://static.easify.xyz/lp/assets/logos/logo-bitcoin.svg',
  ETH: 'https://static.easify.xyz/lp/assets/logos/logo-eth.svg',
  BNB: 'https://static.easify.xyz/lp/assets/logos/logo-bnb.svg'
};
