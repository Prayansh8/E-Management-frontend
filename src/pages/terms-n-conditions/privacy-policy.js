...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy container">
      <h1>
        <strong>E-Management Associated Institute Privacy Policy</strong>
      </h1>
      <p>Our Privacy Policy was last updated on 2023-09-23.</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "We", "Us" or "Our" in this Agreement) refers to E-Management.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>"Website"</strong> refers to learnplace.in, accessible from{" "}
            <a href="https://learnplace.in/">learnplace.in</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        <strong>Phone & Email Marketing</strong>
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          <a href="https://learnplace.in/index.php/contact/">
            learnplace.in/contact
          </a>
        </li>
        <li>By sending us an email: mohit@worksnet.in</li>
      </ul>
      <p>
